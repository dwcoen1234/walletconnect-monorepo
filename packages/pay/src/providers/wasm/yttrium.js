...
const PayJsonFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class PayJson {
    ...
    confirm_payment(request_json) {
        const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
    ...
    constructor(sdk_config_json) {
        try {
            ...
            const ptr0 = passStringToWasm0(sdk_config_json, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
