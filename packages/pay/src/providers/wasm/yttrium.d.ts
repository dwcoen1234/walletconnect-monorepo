...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_1549: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_1890: (a: number, b: number) => void;
  ...
  readonly __wasm_bindgen_func_elem_1341: (a: number, b: number) => void;
